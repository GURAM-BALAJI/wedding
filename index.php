        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <ul class="social-icon ml-lg-3">
                    ...
                    <li><a href="#" class="fa fa-lock"></a></li>
                </ul>
            </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-12 col-12 text-center mb-0 mt-0">
                    <div class="youtebe_video_frame" data-aos="zoom-out-down" data-aos-delay="200"><iframe src="https://www.youtube.com/embed/dmtSX4EweSQ" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen>
                        </iframe></div>
                </div>
                ...
                <div class="wrapper">
                    <div class="gallery">
                        ...
                        <div class="gallery__item gallery__item--6" data-aos="fade-right" data-aos-delay="300">
                            <a class="gallery__link">
                                <img src="images/gal6.jpg" class="gallery__image" />
