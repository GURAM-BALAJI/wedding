        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                ?>
                    ...
                    <div class="form-group">
                        <label for="name1_social_media_1_Type" class="col-sm-4 control-label">Type Social Media-1
                        </label>
                        <div class="col-sm-8">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="name1_social_media_1"
                                name="name1_social_media_1">
                        </div>
                    </div>

                    <div class="form-group">
                        <label for="name1_social_media_2_Type" class="col-sm-4 control-label">Type Social Media-2
                        </label>
                        <div class="col-sm-8">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="name1_social_media_2"
                                name="name1_social_media_2">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label for="name2_social_media_1_Type" class="col-sm-4 control-label">Type Social Media-1
                        </label>
                        <div class="col-sm-8">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="name2_social_media_1"
                                name="name2_social_media_1">
                        </div>
                    </div>


                    <div class="form-group">
                        <label for="name2_social_media_2_Type" class="col-sm-4 control-label">Type Social Media-2
                        </label>
                        <div class="col-sm-8">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="name2_social_media_2"
                                name="name2_social_media_2">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="streaming_password" name="streaming_password"
                                required>
                        </div>
                    </div>
            ...
            <div class="modal-body">
                <form class="form-horizontal" method="POST" action="invitation_edit.php">
                    ...
                    <div class="form-group">
                        <label for="name1_profession" class="col-sm-4 control-label">profession</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="edit_invitation_name1_profession"
                                name="name1_profession">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label for="name1_social_media_1" class="col-sm-4 control-label">Social Media-1</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="edit_invitation_name1_social_media1"
                                name="name1_social_media_1">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label for="name1_social_media_2" class="col-sm-4 control-label">Social Media-2</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="edit_invitation_name1_social_media2"
                                name="name1_social_media_2">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label for="name2_profession" class="col-sm-4 control-label">profession</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="edit_invitation_name2_profession"
                                name="name2_profession">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label for="name2_social_media_1" class="col-sm-4 control-label">Social Media-1</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="edit_invitation_name2_social_media1"
                                name="name2_social_media_1">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label for="name2_social_media_2" class="col-sm-4 control-label">Social Media-2</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="edit_invitation_name2_social_media2"
                                name="name2_social_media_2">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label for="youtube" class="col-sm-4 control-label">Youtube Link</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="edit_invitation_youtube_link" name="youtube"
                                required>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label for="streaming_code" class="col-sm-4 control-label">Streaming Code</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="edit_invitation_streaming_id"
                                name="streaming_code" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label for="streaming_password" class="col-sm-4 control-label">Streaming Password</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="edit_invitation_streaming_password"
                                name="streaming_password" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="invitation_search_name" class="col-sm-4 control-label">Invitation Search Name
                        </label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="edit_invitation_search_name"
                                name="invitation_search_name" required>
                        </div>
                    </div>
